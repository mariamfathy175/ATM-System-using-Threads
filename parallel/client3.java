...
public class client3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        client1 = new javax.swing.JRadioButton();
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(195, 13, 263, 34));
        ...
        getContentPane().add(client2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 360, -1, -1));

        client1.setBackground(new java.awt.Color(255, 255, 255));
        buttonGroup4.add(client1);
        client1.setText("client 1");
        getContentPane().add(client1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 360, -1, -1));
    ...
    private void withdrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawActionPerformed
        ...
        try {
            dos.writeUTF(" withdraw "+user+" "+pass+" "+amount+" "+3);
    ...
    private void depositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositActionPerformed
        ...
        amount=input14.getText();
        try {
            dos.writeUTF(" deposit "+user+" "+pass+" "+amount+" "+3);
        } catch (IOException ex) {
            Logger.getLogger(client3.class.getName()).log(Level.SEVERE, null, ex);
        }  
    ...
    private void checkbalance1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkbalance1ActionPerformed
        amount=input14.getText();
        try {
            dos.writeUTF(" checkbalance "+user+" "+pass+" "+amount+" "+3);
        } catch (IOException ex) {
            Logger.getLogger(client3.class.getName()).log(Level.SEVERE, null, ex);
        }     
    ...
    private void transactionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transactionActionPerformed
        ...
        amount = input14.getText();
        client1.setActionCommand("client1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            dos.writeUTF(" login "+jTextField1.getText()+" "+jTextField2.getText()+" "+amount+" "+3);
        } catch (IOException ex) {
            Logger.getLogger(client3.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void paybillsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paybillsActionPerformed
        amount=input14.getText();
        try {
            dos.writeUTF(" paybill "+user+" "+pass+" "+amount+" "+3);
        } catch (IOException ex) {
            Logger.getLogger(client3.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private static javax.swing.JRadioButton client1;
