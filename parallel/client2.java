...
public class client2 extends javax.swing.JFrame {
    ...
    private void withdrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawActionPerformed
        ...
        try {
            dos.writeUTF(" withdraw "+user+" "+pass+" "+amount+" "+2);
    ...
    private void depositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositActionPerformed
        ...
        amount=input14.getText();
        try {
            dos.writeUTF(" deposit "+user+" "+pass+" "+amount+" "+2);
        } catch (IOException ex) {
            Logger.getLogger(client2.class.getName()).log(Level.SEVERE, null, ex);
        }  
    ...
    private void checkbalance1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkbalance1ActionPerformed
        amount=input14.getText();
        try {
            dos.writeUTF(" checkbalance "+user+" "+pass+" "+amount+" "+2);
        } catch (IOException ex) {
            Logger.getLogger(client2.class.getName()).log(Level.SEVERE, null, ex);
        }     
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            dos.writeUTF(" login "+jTextField1.getText()+" "+jTextField2.getText()+" "+amount+" "+2);
        } catch (IOException ex) {
            Logger.getLogger(client2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void paybillsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paybillsActionPerformed
        amount=input14.getText();
        try {
            dos.writeUTF(" paybill "+user+" "+pass+" "+amount+" "+2);
        } catch (IOException ex) {
            Logger.getLogger(client2.class.getName()).log(Level.SEVERE, null, ex);
        }
